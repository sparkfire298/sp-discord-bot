// Just copypasted from wikipedia.js lol
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('simple-wikipedia')
        .setDescription('Get a Simple English Wikipedia article')
    ...
    async execute(bot, interaction) {
        try {
            ...
            const url = `https://simple.wikipedia.org/api/rest_v1/page/summary/${query}`;
